...
local reward = math.random(2200,200000)
--robber.addMoney(reward)--Чистые деньги
robber.addAccountMoney('black_money', reward)--грязные деньги
TriggerClientEvent('esx:showNotification', robber, "Вы украли помеченные деньги в размере $"..reward.."")
end)
...
for i=1, #RPcops, 1 do
    ...
    if RPcop.job.name == 'police' or RPcop.job.name == 'fbi' then
