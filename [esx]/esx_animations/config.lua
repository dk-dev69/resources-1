...
Config.Animations = {
	
	{
		...
		label = 'Вечеринка',
		items = {
		    {label = "Курить сигарету", type = "scenario", data = {anim = "WORLD_HUMAN_SMOKING"}},
			{label = "Играть на гитаре", type = "scenario", data = {anim = "WORLD_HUMAN_MUSICIAN"}},
			{label = "Dj", type = "anim", data = {lib = "anim@mp_player_intcelebrationmale@dj", anim = "dj"}},
			{label = "Пить пиво (в пакете)", type = "scenario", data = {anim = "WORLD_HUMAN_DRINKING"}},
			{label = "Пить пиво", type = "scenario", data = {anim = "WORLD_HUMAN_PARTYING"}},
			{label = "Виртуальная гитара", type = "anim", data = {lib = "anim@mp_player_intcelebrationmale@air_guitar", anim = "air_guitar"}},
			{label = "Dokowanie", type = "anim", data = {lib = "anim@mp_player_intcelebrationfemale@air_shagging", anim = "air_shagging"}},
			{label = "Рок-н-ролл", type = "anim", data = {lib = "mp_player_int_upperrock", anim = "mp_player_int_rock"}},
			-- {label = "Fumer un jo	int", type = "scenario", data = {anim = "WORLD_HUMAN_SMOKING_POT"}},
			{label = "Пьяный", type = "anim", data = {lib = "amb@world_human_bum_standing@drunk@idle_a", anim = "idle_a"}},
			{label = "Рвота из автомобиля", type = "anim", data = {lib = "oddjobs@taxi@tie", anim = "vomit_outside"}},
		}
	},

	{
		...
		label = 'Приветствия',
		items = {
			{label = "Добро пожаловать", type = "anim", data = {lib = "gestures@m@standing@casual", anim = "gesture_hello"}},
			{label = "Привет", type = "anim", data = {lib = "mp_common", anim = "givetake1_a"}},
			{label = "Дай мне свою руку", type = "anim", data = {lib = "mp_ped_interaction", anim = "handshake_guy_a"}},
			{label = "Гангстерское приветствие", type = "anim", data = {lib = "mp_ped_interaction", anim = "hugs_guy_a"}},
			{label = "Салют", type = "anim", data = {lib = "mp_player_int_uppersalute", anim = "mp_player_int_salute"}},
		}
	},
...

	{
		...
		label = 'Спорт',
		items = {
			{label = "Напречь мышцы", type = "anim", data = {lib = "amb@world_human_muscle_flex@arms_at_side@base", anim = "base"}},
			{label = "Выжать штангу", type = "anim", data = {lib = "amb@world_human_muscle_free_weights@male@barbell@base", anim = "base"}},
	...
	
	{
		...
		label = '+18',
		items = {
			{label = "Глубокое горло", type = "anim", data = {lib = "oddjobs@towing", anim = "m_blow_job_loop"}},
			{label = "Миньет", type = "anim", data = {lib = "oddjobs@towing", anim = "f_blow_job_loop"}},
			...
			{label = "Стриптиз", type = "anim", data = {lib = "mini@strip_club@lap_dance@ld_girl_a_song_a_p1", anim = "ld_girl_a_song_a_p1_f"}},
			{label = "Стриптиз 2", type = "anim", data = {lib = "mini@strip_club@private_dance@part2", anim = "priv_dance_p2"}},
			{label = "Эротический танец", type = "anim", data = {lib = "mini@strip_club@private_dance@part3", anim = "priv_dance_p3"}},
		}
	},
}
