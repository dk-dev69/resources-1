...
Config.Strings = {
    ['drive_next'] = 'Доехать до следующего ~y~чекпоинта',
    ['start_npc'] = 'Нажмите ~INPUT_CONTEXT~ чтобы начать гонку против NPC',
    ['start_online'] = 'Нажмите ~INPUT_CONTEXT~ чтобы начать гонку против других игроков',
    ['stop_online'] = 'Нажмите ~INPUT_CONTEXT~ чтобы отменить готовность'
}
...
Config.OnlineRace = {
    [1] = {
        ...
        Text = 'Нажмите ~INPUT_CONTEXT~ запустить гонку против 2 других игроков! (собственный автомобиль)',
    ...
    [2] = {
        Players = 2,
        Type = 'event',
        Text = 'Нажмите ~INPUT_CONTEXT~ запустить гонку против 1 игрока (мотокросс)',
