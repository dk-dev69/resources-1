...
AddEventHandler('medSystem:near', function(x,y,z, pulse, blood, nameF, nameL, area, bldn)
	...
	if GetDistanceBetweenCoords(x,y,z,a,b,c,false) < 10 then
		timer = 10
		TriggerEvent('chatMessage', "MedSystem", {255,0 , 0}, "^1 [0-5] Мертв ^6[5-15] Нужно идти в больницу ^5[15-38] Врач может помочь ^4[38-55] Полиция может помочь ^2[55+] Здоров")
		cBlood = blood
		cPulse = pulse
		cNameF = nameF
		cNameL = nameL
