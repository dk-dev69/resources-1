...
if modele == 3 then
	...
	TriggerClientEvent('showNotify', -1, "~g~Счет ~r~Красная команда: " .. pointagerouge .. "~b~ Синяя команда: " .. pointagebleu)
	else
	TriggerClientEvent('showNotify', -1, "~r~Первая команда  ~g~выиграла~w~~b~ игру!")
	pointagebleu = 0
    pointagerouge = 0
	end
end
...
TriggerClientEvent('showNotify', -1, "~b~Вторая команда  ~g~выиграла~w~~b~ игру!")
pointagebleu = 0
pointagerouge = 0
end
end
