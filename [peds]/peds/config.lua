...
Config.EnableWeapons              = true    -- Если TRUE, появляется охранник с оружием (может измениться в main.lua)
--Biker DLC--
...
Config.Locations1 = { -- Some Shop & Interior NPCs
	...
	{ x = -659.00, y = 939.00,   z = 22.00, heading = 274.00 },    -- Магазин аммуниции
	{ x = 73.8600, y = -1392.42,   z = 28.3800, heading = 277.59 },    -- Магазин одежды бульвар инносенс
	{ x = 21.61, y = -1098.05,   z = 26.4200, heading = 20.62 },    -- Автосалон
	{ x = 21.72, y = -1112.00,   z = 28.7800, heading = 277.86 }    -- Магазин оружия бульвар адамс еппл
}
...
Config.Locations22 = { -- Guards Weapons 
	...
	{ x = -631.00,   y = -233.00, z = 37.00, heading = 221.00 },	-- Охранник в самом магазине
	{ x = 259.82,   y = 218.03, z = 106.29, heading = 147.57 }, -- Охранник в банке альта стрит
	{ x = 264.13,   y = 222.78, z = 106.29, heading = 113.83 }, -- Охранник в банке альта стрит
	
}

Config.Locations23 = { -- Магазины аммуниции NPC
	{ x = 23.00,   y = -110.00, z = 30.00, heading = 155.00 },	-- ПРОДАВЕЦ В МАГАЗИНЕ
	{ x = -660.00,   y = -933.00, z = 22.00, heading = 171.00 },	-- ПРОДАВЕЦ В МАГАЗИНЕ
	{ x = 809.41,   y = -2159.08, z = 29.620000, heading = 0.47 },	-- ПРОДАВЕЦ В МАГАЗИНЕ
	{ x = 24.22,   y = -1107.21, z = 29.80000, heading = 116.62 },	-- ПРОДАВЕЦ В МАГАЗИНЕ
	{ x = 1695.49,   y = 3761.41, z = 34.20000, heading = 152.62 },	-- ПРОДАВЕЦ В МАГАЗИНЕ
	{ x = -331.33,   y = 6085.99, z = 31.45000, heading = 219.05 },	-- ПРОДАВЕЦ В МАГАЗИНЕ
}

Config.Locations24 = { -- Магазины аммуниции NPC
	{ x = 254.37,   y = -49.97, z = 69.94000, heading = 69.63 },	-- ПРОДАВЕЦ В МАГАЗИНЕ
	{ x = 2565.79,   y = 294.15, z = 108.73, heading = 285.4 },	-- ПРОДАВЕЦ В МАГАЗИНЕ
	{ x = -1118.47,   y = 2700.37, z = 18.55, heading = 213.86 },	-- ПРОДАВЕЦ В МАГАЗИНЕ
	{ x = 841.4,   y = -1035.35, z = 28.19, heading = 1.84 },	-- ПРОДАВЕЦ В МАГАЗИНЕ
}

Config.Locations25 = { -- Some Shop & Interior NPCs
	{ x = -138.89, y = -633.93,   z = 168.82, heading = 13.83 },    -- Центр занятости
	--{ x = -351.76, y = -989.44,   z = 31.25, heading = 255.65 },    -- Центр занятости
}
