local colors = {
{name = "Черный", colorindex = 0},{name = "Черный карбон", colorindex = 147},
...
------Window tint------
	windowtint = {
		{ name = "Чистый черный", tint = 1, price = 1000},
		{ name = "Темный дым", tint = 2, price = 1000},
		{ name = "Светлый дым", tint = 3, price = 1000},
		{ name = "Limo", tint = 4, price = 1000},
		{ name = "Зеленый оттенок", tint = 5, price = 1000},
	},
...
------Neon layout------
	neonlayout = {
		{name = "Передняя, задняя и боковые", price = 5000},
	},
	--Neon color
	neoncolor = {
		{ name = "Белый", neon = {255,255,255}, price = 1000},
...
----Back wheel (Bikes)-----
	backwheel = {
		{name = "По умолчанию", wtype = 6, mod = -1, price = 1000},
		{name = "Speedway", wtype = 6, mod = 0, price = 1000},
		{name = "Streetspecial", wtype = 6, mod = 1, price = 1000},
		{name = "Racer", wtype = 6, mod = 2, price = 1000},
		{name = "Trackstar", wtype = 6, mod = 3, price = 1000},
...
----Sport wheels-----
	sportwheels = {
		{name = "По умолчанию", wtype = 0, mod = -1, price = 1000},
