...
Config.Items = {
    [1] = {label = "Вода",       item = "water",        price = 5},
    [2] = {label = "Хлеб",      item = "bread",       price = 5},
}
