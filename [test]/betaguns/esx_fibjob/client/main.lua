...
function OpenCloakroomMenu()
	...
	if grade == 'agent' then
		table.insert(elements, {label = _U('fib_wear'), value = 'agent_wear'})
	elseif grade == 'swat' then
		table.insert(elements, {label = _U('fib_wear'), value = 'swat_wear'})
	elseif grade == 'agentcatainassistant' then
		table.insert(elements, {label = _U('fib_wear'), value = 'agentcatainassistant_wear'})
	elseif grade == 'swatcatainassistant' then
		table.insert(elements, {label = _U('fib_wear'), value = 'swatcatainassistant_wear'})
	elseif grade == 'agentcaptain' then
		table.insert(elements, {label = _U('fib_wear'), value = 'agentcaptain_wear'})
	elseif grade == 'swatcaptain' then
		table.insert(elements, {label = _U('fib_wear'), value = 'swatcaptain_wear'})
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'cloakroom',
	{
		...
		if
			...
			data.current.value == 'agentcaptainassistant_wear' or
			data.current.value == 'swatcaptainassistant_wear' or
			data.current.value == 'agentcaptain_wear' or
			data.current.value == 'swatcaptain_wear' or
...
--Citizen.CreateThread(function()
	...
	--or k,v in pairs(Config.PoliceStations) do
