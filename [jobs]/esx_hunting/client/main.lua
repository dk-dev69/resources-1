...
ESX  = nil
local Blips = {
	{ name="Охотничий пункт", id=463,x= -1145.0, y= 4909.46, z= 220.97},
	{ name="Мясо и шкура", id=463,x = 2580.89, y = 462.16, z = 109.28},
}

--{title="Охотничий пункт", colour=9, id=463, x = 2580.89, y = 462.16, z = 109.28},
 --Лифт в здании FBI  141.08 -765.99 45.75
--{title="Мясо и шкура", colour=9, id=463, x = 2580.89, y = 462.16, z = 109.28},
...
local Positions = {
    ['StartHunting'] = { ['hint'] = '[E] Начать охоту', ['x'] = -1145.0, ['y'] = 4909.46, ['z'] = 220.97 },
	-- ['StartHunting'] = { ['hint'] = '[E] Начать охоту', ['x'] = -769.23773193359, ['y'] = 5595.6215820313, ['z'] = 33.48571395874 },
	['Sell'] = { ['hint'] = '[E] Продать', ['x'] = 2580.89, ['y'] = 462.16, ['z'] = 108.6 },
	-- ['SpawnATV'] = { ['x'] = -769.63067626953, ['y'] = 5592.7573242188, ['z'] = 33.48571395874 }
	['SpawnATV'] = { ['x'] = -1147.55, ['y'] = 4916.49, ['z'] = 220.19 }
}
	...
	Citizen.CreateThread(function()
		for index, v in ipairs(Positions) do
			if index ~= 'SpawnATV' then
				...
				SetBlipColour(StartBlip, 49)
				SetBlipDisplay(StartBlip, 4)
				SetBlipScale(StartBlip, 0.6)
				SetBlipAsShortRange(StartBlip, true)
				BeginTextCommandSetBlipName("STRING")
				AddTextComponentString('Место охоты')
						...
						if distance < 5.0 then
							if IsControlJustReleased(0, Keys['E']) then
								if index == 'StartHunting' then
									StartHuntingSession()
									TriggerEvent('esx:showNotification', "~r~Найдите цели на карте~s~, убейте все и разделайте.")
								else
									SellItems()
								end
							end
							...
							if PlyToAnimal < 2.0 then
								...
								if IsControlJustReleased(0, Keys['E']) then
									if GetSelectedPedWeapon(PlayerPedId()) == GetHashKey('WEAPON_KNIFE')  then
										...
										ESX.ShowNotification('Используйте нож!')
									end
								end
...
function SlaughterAnimal(AnimalId)
	...
	ESX.ShowNotification('Вы получили мясо весом ' ..AnimalWeight.. 'кг')
