Locales['ru'] = {
	--Global menus
		['cloakroom'] 								= 'Гардероб',
		['cloak_change'] 							= 'Нажмите ~INPUT_PICKUP~ чтобы переодеться.',
	...
	--Lumber Jack job
		...
		['lj_mapblip'] 								= 'Деревянные сваи',
		['lj_wood'] 									= 'Древесина',
		['lj_pickup'] 								= 'Нажмите ~INPUT_PICKUP~ для получения древесины.',
		['lj_cutwood'] 								= 'Пилорамма',
		['lj_cutwood_button'] 				= 'Нажмите ~INPUT_PICKUP~ чтобы распилить древесину.',
		['lj_board'] 									= 'Доски',
