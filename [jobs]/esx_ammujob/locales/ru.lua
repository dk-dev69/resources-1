Locales['ru'] = {
  ...
  ['ammu_wear'] = 'Рабочая одежда',
  ['gilet_wear'] = 'Продавец одежды',
  ['bullet_wear'] = 'Кевларовый жилет',
  ['no_outfit'] = 'Нет подходящей вам униформы!',
  ['open_cloackroom'] = 'Нажмите ~INPUT_CONTEXT~ для открытия гардероба',
  ['harvest'] = 'Части оружия',
  ...
  ['deposit_object'] = 'Разместить предмет',
  ['get_weapon'] = 'Достать пистолет',
  ...
  ['vehicle_blocked'] = 'В гараже уже есть машина',
