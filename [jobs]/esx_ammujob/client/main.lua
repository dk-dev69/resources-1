			...
			for k,v in pairs(Config.PoliceStations) do
				...
				for i=1, #v.Cloakrooms, 1 do
					if GetDistanceBetweenCoords(coords, v.Cloakrooms[i].x, v.Cloakrooms[i].y, v.Cloakrooms[i].z, true) < Config.DrawDistance then
						DrawText3Ds(v.Cloakrooms[i].x, v.Cloakrooms[i].y, v.Cloakrooms[i].z, 'Нажмите [E], чтобы переодеться')
					end
				end

				for i=1, #v.Armories, 1 do
					if GetDistanceBetweenCoords(coords, v.Armories[i].x, v.Armories[i].y, v.Armories[i].z, true) < Config.DrawDistance then
						DrawText3Ds(v.Armories[i].x, v.Armories[i].y, v.Armories[i].z, 'Нажмите [E], чтобы открыть арсенал')
					end
				end

				for i=1, #v.Vehicles, 1 do
					if GetDistanceBetweenCoords(coords, v.Vehicles[i].Spawner.x, v.Vehicles[i].Spawner.y, v.Vehicles[i].Spawner.z, true) < Config.DrawDistance then
						DrawText3Ds(v.Vehicles[i].Spawner.x, v.Vehicles[i].Spawner.y, v.Vehicles[i].Spawner.z, 'Нажмите [E], чтобы открыть гараж')
					end
				end

				for i=1, #v.VehicleDeleters, 1 do
					if GetDistanceBetweenCoords(coords, v.VehicleDeleters[i].x, v.VehicleDeleters[i].y, v.VehicleDeleters[i].z, true) < Config.DrawDistance then
						DrawText3Ds(v.VehicleDeleters[i].x, v.VehicleDeleters[i].y, v.VehicleDeleters[i].z, 'Нажмите [E], чтобы сохранить автомобиль')
					end
				end
				...
				for i=1, #v.Garage, 1 do
					if GetDistanceBetweenCoords(coords, v.Garage[i].x, v.Garage[i].y, v.Garage[i].z, true) < Config.DrawDistance then
						DrawText3Ds(v.Garage[i].x, v.Garage[i].y, v.Garage[i].z, 'Нажмите [E], чтобы подобрать оружие')
					end
				end
				...
				if Config.EnablePlayerManagement and PlayerData.job.grade_name == 'boss' then
					for i=1, #v.BossActions, 1 do
						if not v.BossActions[i].disabled and GetDistanceBetweenCoords(coords, v.BossActions[i].x, v.BossActions[i].y, v.BossActions[i].z, true) < Config.DrawDistance then
							DrawText3Ds(v.BossActions[i].x, v.BossActions[i].y, v.BossActions[i].z, 'Нажмите [E], чтобы получить доступ к управлению')
						end
					end
				end
