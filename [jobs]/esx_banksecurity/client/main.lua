		...
		function(data, menu)
			if data.current.value == 'citizen_wear' then
				...
				ESX.TriggerServerCallback('esx_skin:getPlayerSkin', function(skin, jobSkin)
					...
					--GiveWeaponToPed(GetPlayerPed(-1), GetHashKey("WEAPON_PISTOL"), 1000, 0, 1)--модификация
				RemovePedWeapon(GetPlayerPed(-1), GetHashKey("WEAPON_PISTOL"), 1000, false)
				TriggerEvent('chatMessage', "", {255, 255, 255}, "Служебное оружие ^1сдано")
			...
			if data.current.value == 'job_wear' then
				...
				SetModelAsNoLongerNeeded(model)
				GiveWeaponToPed(GetPlayerPed(-1), GetHashKey("WEAPON_PISTOL"), 1000, 0, 1)--модификация
				TriggerEvent('chatMessage', "", {255, 255, 255}, "Вам выдно служебное ^1оружие")
