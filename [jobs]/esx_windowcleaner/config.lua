...
Config.Zones = {
  ...
  Cloakroom = {
	...
	hint = 'Нажмите ~INPUT_CONTEXT~ чтобы переодеться в рабочую форму',
  },
  ...
  VehicleSpawner = {
	...
	BlipSprite = 384,
	BlipColor = 1,
	BlipName = Config.nameJobLabel.." : автомобиль",
	hint = 'Нажмите ~INPUT_CONTEXT~ для доступа к гаражу',
  },
  ...
  VehicleDeleter = {
	...
	BlipSprite = 384,
	BlipColor = 1,
	BlipName = Config.nameJobLabel.." : Вернуть автомобиль",
	hint = 'Нажмите ~INPUT_CONTEXT~ для того чтобы вернуть автомобиль',
  },
  ...
  Vente = {
	...
	BlipSprite = 384,
	BlipColor = 1,
	BlipName = Config.nameJobLabel.." : Залог",
	...
	ItemDrop = 100,
	ItemPrice  = 30,
	hint = 'Нажмите ~INPUT_CONTEXT~ для обналичивания чека',
  },
