...
INSERT INTO `job_grades` (job_name, grade, name, label, salary, skin_male, skin_female) VALUES
	('cartel',0,'soldato','Aspirant',20,'{}','{}'),
	('cartel',1,'capo','Biträdande Rikspolischef',40,'{}','{}'),
	('cartel',2,'consigliere','Assistent',60,'{}','{}'),
	('cartel',3,'lieutenant','Inspektör',85,'{}','{}'),
	('cartel',4,'boss','Rikspolischef',100,'{}','{}')
;
