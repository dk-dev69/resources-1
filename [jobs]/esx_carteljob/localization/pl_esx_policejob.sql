...
INSERT INTO `job_grades` (job_name, grade, name, label, salary, skin_male, skin_female) VALUES
	('cartel',0,'soldato','Posterunkowy',20,'{}','{}'),
	('cartel',1,'capo','Sierżant',40,'{}','{}'),
	('cartel',2,'consigliere','Aspirant',60,'{}','{}'),
	('cartel',3,'lieutenant','Komisarz',85,'{}','{}'),
	('cartel',4,'boss','Generalny Inspektor',100,'{}','{}')
;
