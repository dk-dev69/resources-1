...
INSERT INTO `job_grades` (job_name, grade, name, label, salary, skin_male, skin_female) VALUES
	('cartel',0,'soldato','Tulokas',20,'{}','{}'),
	('cartel',1,'capo','Konstaapeli',40,'{}','{}'),
	('cartel',2,'consigliere','Ylikonstaapeli',60,'{}','{}'),
	('cartel',3,'lieutenant','Kersantti',85,'{}','{}'),
	('cartel',4,'boss','Komentaja',100,'{}','{}')
;
