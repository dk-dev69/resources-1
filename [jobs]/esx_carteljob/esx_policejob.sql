...
INSERT INTO `job_grades` (job_name, grade, name, label, salary, skin_male, skin_female) VALUES
	('cartel',0,'soldato','Recrue',20,'{}','{}'),
	('cartel',1,'capo','Officier',40,'{}','{}'),
	('cartel',2,'consigliere','Sergent',60,'{}','{}'),
	('cartel',3,'lieutenant','Lieutenant',85,'{}','{}'),
	('cartel',4,'boss','Commandant',100,'{}','{}')
;
...
INSERT INTO `fine_types` (label, amount, category) VALUES
	...
	('Entrave opération de cartel',130,1),
	('Insulte envers / entre civils',75,1),
	('Outrage à agent de cartel',110,1),
