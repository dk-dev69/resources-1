Locales['fi'] = {
  ...
  ['confirm_yes'] = 'yes',
  -- Service
  ['service_max'] = 'you cannot enter service, max capos in service: %s/%s',
  ...
  -- Notifications
  ['alert_cartel'] = 'hälyytys Poliisi',
  ['phone_cartel'] = 'poliisi',
}