...
INSERT INTO `job_grades` (job_name, grade, name, label, salary, skin_male, skin_female) VALUES
	('militar',0,'recruit','Рекрут',9000,'{}','{}'),
	('militar',1,'officer','Сержант',18000,'{}','{}'),
	('militar',2,'sergeant','Лейтенант',25000,'{}','{}'),
	('militar',3,'lieutenant','Полковник',40000,'{}','{}'),
	('militar',4,'boss','Генерал',50000,'{}','{}')
;
...
INSERT INTO `fine_types` (label, amount, category) VALUES
	('Не уместное использование клаксона',30,0),
	...
	('Entrave opération de militar',130,1),
	('Insulte envers / entre civils',75,1),
	('Outrage à agent de militar',110,1),
