...
Config.MarkerTypeBoat   = 35
Config.MarkerTypePlane   = 7
...
Config.PoundMarker = {
	r = 0, g = 168, b = 255,     -- Blue Color
	x = 1.5, y = 1.5, z = 1.0  -- Standard Size Circle
}

Config.JobPoundMarker = {
	r = 255, g = 71, b = 87,     -- Red Color
	x = 1.5, y = 1.5, z = 1.0  -- Standard Size Circle
}
-------------------------BOAT MARKER------------------------
...
Config.PolicePounds = {
	Pound_LosSantos = {
		...
		SpawnPoint = { x = 391.74, y = -1619.0, z = 29.29, h = 318.34 }
	},
	Pound_Sandy = {
	...
	Pound_Paleto = {
		...
		SpawnPoint = { x = -230.88, y = 6255.89, z = 31.49, h = 136.5 }
	}
}
...
Config.CarGarages = {
	...
	Garage_Office_Job = {
		GaragePoint = { x = -348.95, y = -875.06, z = 31.32 },
		SpawnPoint = { x = -351.29, y = -891.64, z = 31.07, h = 0.03 },
		DeletePoint = { x = -343.93, y = -884.07, z = 31.07 }
	},
	...
	Garage_Prison = {
		GaragePoint = { x = 1854.81, y = 2578.61, z = 45.90 },--тюрьма
		SpawnPoint = { x = 1854.81, y = 2578.61, z = 45.90, h = 274.8 },
...
Config.CarPounds = {
	Pound_LosSantos = {
		...
		SpawnPoint = { x = 405.64, y = -1643.4, z = 29.61, h = 229.54 }
	},
	Pound_Sandy = {
		PoundPoint = { x = 1666.13, y = 3831.24, z = 34.4 },
		SpawnPoint = { x = 1671.76, y = 3824.47, z = 34.42, h = 346.53 }
	},
	Pound_Paleto = {
		PoundPoint = { x = -234.82, y = 6198.65, z = 31.94 },
		SpawnPoint = { x = -230.08, y = 6190.24, z = 31.49, h = 140.24 }
	}
}
...
Config.BoatGarages = {
	Garage_LSDock = {
		...
		SpawnPoint = { x = -718.87, y = -1320.18, z = 0.0, h = 45.0 },
		DeletePoint = { x = -731.15, y = -1334.71, z = 0.0 }
	},
	Garage_SandyDock = {
		GaragePoint = { x = 1333.2, y = 4269.92, z = 31.5 },
		SpawnPoint = { x = 1334.61, y = 4264.68, z = 29.86, h = 87.0 },
		DeletePoint = { x = 1326.22, y = 4282.22, z = 30.05 }
	},
	Garage_PaletoDock = {
...
Config.AircraftGarages = {
	Garage_LSAirport = {
		...
		SpawnPoint = { x = -1657.99, y = -3134.38, z = 14.99, h = 330.11 },
...
Config.AircraftPounds = {
	Pound_LSAirport = {
		...
		SpawnPoint = { x = -1272.27, y = -3382.46, z = 13.94, h = 330.25 }
	}
}
