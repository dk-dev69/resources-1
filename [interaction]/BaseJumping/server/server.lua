...
AddEventHandler('ogBj:baseJumpingCharge', function()
	...
	TriggerClientEvent("pNotify:SendNotification", _source, {text = "<center><strong><b style='color:#B2FF33'>Прыжки с парашютом</b><strong><br /> <br /> Вы заплатили 50$, за парашют... Наслаждайтесь прыжком!<center>", type = "success", queue = "global", timeout = 5000, layout = "centerRight" })
	xPlayer.removeMoney(50)
	
	else 
	
	TriggerClientEvent("pNotify:SendNotification", _source, {text = "<center><strong><b style='color:#B2FF33'>Прыжки с парашютом</b><strong><br /> <br /> У вас недостаточно денег, для покупки парашюта.", type = "success", queue = "global", timeout = 5000, layout = "centerRight" })
	
	end
	
	else
	
	TriggerClientEvent("pNotify:SendNotification", _source, {text = "<center><strong><b style='color:#B2FF33'>Прыжки с парашютом</b><strong><br /> <br /> Вы получили парашют... Наслаждайтесь прыжком!<center>", type = "success", queue = "global", timeout = 5000, layout = "centerRight" })
